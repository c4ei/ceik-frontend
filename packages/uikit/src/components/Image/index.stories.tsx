...
export const TokenImages: React.FC<React.PropsWithChildren> = () => {
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        const src = `https://ceik.c4ei.net/images/tokens/${token.address[56]}.png`;
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        ...
        const primarySrc = `https://ceik.c4ei.net/images/tokens/${token.address[56]}.png`;
        const secondarySrc = `https://ceik.c4ei.net/images/tokens/${tokens[randomTokenIndex].address[56]}.png`;
