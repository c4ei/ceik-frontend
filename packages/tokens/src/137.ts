...
import { BUSD_POLYGON, CAKE_POLYGON } from './common'

export const polygonTokens = {
  wbnb: WBNB[ChainId.POLYGON],
  busd: BUSD_POLYGON,
  cake: CAKE_POLYGON,
  // syrup: new Token( ChainId.C4EI, '0xABB8a013F21a491C2e35d143A31FB708499A92c0', 18, 'SYRUP', 'SyrupBar Token', 'https://swap.c4ei.net/', ),
  // eth: new Token( ChainId.C4EI, '0xD7D1F3448c6979041de1Ac136a74394aDd746ff0', 18, 'wETH', 'w Ether', 'https://swap.c4ei.net/', ),
