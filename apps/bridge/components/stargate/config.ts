import { avalandche, c4ei, fantomOpera } from '@pancakeswap/wagmi/chains'
...
export const CHAINS_STARGATE = [mainnet, arbitrum, optimism, polygon, avalandche, fantomOpera, c4ei]
