...
const BLOCK_SUBGRAPH_ENDPOINT = 'https://api.c4ei.net/subgraphs/name/pancakeswap/blocks'
const INFO_SUBGRAPH_ENDPOINT = 'https://api.c4ei.net/subgraphs/name/pancakeswap/exchange-v2'
const STABLESWAP_SUBGRAPH_ENDPOINT = 'https://api.c4ei.net/subgraphs/name/pancakeswap/exchange-stableswap'
