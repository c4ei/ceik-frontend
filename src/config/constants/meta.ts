...
export const DEFAULT_META: PageMeta = {
  title: 'swap.c4ei.net',
  description:
    'The most popular AMM on C4EI! Earn ALBA through yield farming.',
  image: 'https://swap.c4ei.net/images/hero.png',
}
...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    paths: {
      ...
      '/info': { title: t('Overview'), description: 'View statistics for C4eiSwap exchanges.' },
      '/info/pools': { title: t('Pools'), description: 'View statistics for C4eiSwap exchanges.' },
      '/info/tokens': { title: t('Tokens'), description: 'View statistics for C4eiSwap exchanges.' },
